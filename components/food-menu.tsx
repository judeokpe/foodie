...
const FoodMenu = () => {
    ...
    return ( 
       <>
       <div className="text-3xl text-center text-yellow-500">- Our Menu -</div>
        ...
        <div className="flex flex-wrap  justify-center items-center ">
            ...
            {Food.map((item)=>
                (
                    ...
                    <div className=" w-full sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/7 h-[50vh]  rounded-md bg-white m-1 px-4 py-2" >
